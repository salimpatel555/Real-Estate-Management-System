                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method='post' action='<?php echo base_url(); ?>submit_property_details' enctype='multipart/form-data' id="submit_form_mult">
                            <?php $this->load->view('admin/wizards'); ?>
                            <!-- wizard-nav -->
                            <?php $this->load->view('admin/wizard_tab1'); ?>
                            <!-- wizard-tab -->
                            <?php $this->load->view('admin/wizard_tab2'); ?>
                            <!-- wizard-tab -->
                            <?php $this->load->view('admin/wizard_tab3'); ?>
                            <!-- wizard-tab -->
                            <?php $this->load->view('admin/wizard_tab4'); ?>

                            <?php $this->load->view('admin/wizard_tab5'); ?>
