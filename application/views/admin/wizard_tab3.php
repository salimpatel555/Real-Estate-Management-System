    ...
    <div>
        ...
        <div>
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label for="basicpill-namecard-input" class="form-label" id="property_diamention">Enter Property Dimension</label>
                        <input type="text" class="form-control" name="property_diamention_val" id="property_diamention_val" placeholder="Enter Property Dimension in sq.ft" />
                    </div>
                </div>
                <!-- end col -->
                <!-- <div class="col-lg-3">
